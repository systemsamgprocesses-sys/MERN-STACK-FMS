        ...
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="p-3 rounded-lg shadow-md" style={{ backgroundColor: 'var(--color-surface)' }}>
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-xs" style={{ color: 'var(--color-textSecondary)' }}>Completion Rate</p>
                            <p className="text-2xl font-bold mt-0.5" style={{ color: 'var(--color-success)' }}>
                                {completionRate}%
                            </p>
                        </div>
                        <Target className="w-8 h-8" style={{ color: 'var(--color-success)', opacity: 0.3 }} />
                    </div>
                </div>
            </div>
